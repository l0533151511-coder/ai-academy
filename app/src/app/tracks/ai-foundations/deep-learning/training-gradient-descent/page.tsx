...
const QUIZ: QuizQuestion[] = [
  {
    ...
    optionNotes: [
      "שגוי: learning rate גבוה לרוב מונע הצלחה, לא מאיץ אותה.",
  ...
  {
    id: "q3",
    question: "ה-loss על נתוני האימון ממשיך לרדת יפה, אבל ה-loss על נתוני הוולידציה מתחיל לעלות. מה זה?",
    options: [
    ...
    optionNotes: [
      "שגוי: ב-underfitting שני ה-loss גבוהים — המודל לא לומד אפילו את האימון.",
    ...
    content: (
      <div>
        <p className="mb-4 text-sm text-muted">
          ...
          כל דוגמאות האימון נקרא epoch; כל צעד עובד על batch קטן
    ...
    content: (
      <div className="rounded-xl border border-border bg-card p-4 text-sm">
        ...
        <ol className="list-decimal space-y-1.5 pr-5">
          <li>Loss הוא מה שממזערים; Gradient Descent יורד במורדו צעד-צעד.</li>
          <li>Learning rate הוא trade-off: גדול מדי מתבדר, קטן מדי איטי.</li>
          <li>Overfitting = train יורד, validation עולה. בלי סט וולידציה אתה עיוור לזה.</li>
          <li>בפרודקשן: רוב הזמן הולך לנתונים, לא למודל. garbage in, garbage out.</li>
        </ol>
      </div>
    ),
  },
