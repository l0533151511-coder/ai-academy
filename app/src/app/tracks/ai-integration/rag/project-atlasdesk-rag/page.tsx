  ...
  { id: "slides", label: "מצגת: הפרויקט המסכם של המודול", content: <SlideDeck slides={SLIDES} /> },
  {
    ...
    content: (
      <EngineeringInsights
        ...
        whenNotTo="ה-trade-off המרכזי כאן הוא סף ה-similarity (0.3): סף גבוה מדי → המערכת אומרת 'אין לי מידע' גם כשהמאמר קיים (recall נמוך, לקוח מתוסכל); סף נמוך מדי → מזריקה מאמר לא-רלוונטי ומולידה הזיה משכנעת (faithfulness נמוך). אין ערך 'נכון' אוניברסלי — מכיילים אותו מול eval set אמיתי, בדיוק כמו שלמדנו בשיעור הקודם."
